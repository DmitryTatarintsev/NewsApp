...
//  NewsApp
//
//  Created by Dmitry Tatarintsev on 20.03.2021.
//
...
class PageViewController: UIPageViewController, UIPageViewControllerDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.showDetailViewControllers()
    ...
    func showDetailViewControllers(){
    ...
    func pageViewController(for index: Int) -> OneNewsViewController?{
        ...
        let vc = (storyboard?.instantiateViewController(identifier: "oneNewsSID") as!
